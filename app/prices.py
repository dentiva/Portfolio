...
Provider order per symbol:
  ...
  2. yfinance batch — fallback for any symbol that's missing from TV or
     doesn't have a tv_url (macro indicators, anything user hasn't mapped)
  3. SQLite cache — last resort when both live providers fail
